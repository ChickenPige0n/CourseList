 ...
 * 内联 SVG 图标库。
 *
 * 每个条目只保存 `<svg>` 的内部标记，外层元素由 `AppIcon.vue` 统一渲染，
 * 以保证尺寸、描边与无障碍属性（aria-hidden / focusable=false）一致。
 */

export interface IconDefinition {
  /** `<svg>` 内部标记。 */
  readonly body: string
  /** 实心图标使用 fill，描边图标使用 stroke。 */
...
export const ICONS = {
  ...
  'clipboard-paste':
    '<path d="M15 2H9a1 1 0 0 0-1 1v2c0 .6.4 1 1 1h6c.6 0 1-.4 1-1V3c0-.6-.4-1-1-1Z"/><path d="M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2"/>',
  trash:
